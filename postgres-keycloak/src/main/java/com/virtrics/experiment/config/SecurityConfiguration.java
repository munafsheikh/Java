...
public class SecurityConfiguration {
    ...
    //    class SecurityConfig { // https://www.baeldung.com/spring-boot-keycloak
    ...
    public SecurityFilterChain resourceServerFilterChain(HttpSecurity http) throws Exception {
        http.authorizeHttpRequests(auth -> auth
                ...
                .hasRole("Virtrics-User")
                .requestMatchers(new AntPathRequestMatcher("/Administrator/*"))
                .hasRole("Virtrics-Administrator")
